		...
		return `
			<tr class="${rowClass} hover:bg-gray-700 transition-colors">
				...
				<td class="p-3 border-b border-gray-600">
					<span class="${
						game.player1name === currentUser.name ? 'font-bold text-blue-400' : 
				...
				<td class="p-3 border-b border-gray-600">
					<span class="${
						game.player2name === currentUser.name ? 'font-bold text-blue-400' : 
				...
				<td class="p-3 border-b border-gray-600 text-center">
					<span class="font-semibold ${
						game.winner === currentUser.name ? 'text-green-400' : 
				...
				<div class="flex space-x-2">
					<button onclick="switchHistoryView('my-games')" 
							class="px-3 py-1 rounded text-sm transition-colors ${
								currentHistoryView === 'my-games' ? 'bg-blue-600 text-white' : 'bg-gray-600 text-gray-300 hover:bg-gray-500'
							}">
						My Games
					</button>
					<button onclick="switchHistoryView('all')" 
							class="px-3 py-1 rounded text-sm transition-colors ${
								currentHistoryView === 'all' ? 'bg-blue-600 text-white' : 'bg-gray-600 text-gray-300 hover:bg-gray-500'
							}">
						All Games
					</button>
